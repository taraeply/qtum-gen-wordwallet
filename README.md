...
3. Run the java -jar QtumWalletKeyStore.jar command by navigating to the uncompressed path from the command prompt.
4. Use according to menu.
...
3. 명령 프롬프트에서 압축을 해제한 경로로 이동하여 java -jar QtumWalletKeyStore.jar 명령을 실행 합니다.
